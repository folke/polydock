...
export function memory_append_char(buf: number[], pos: number[], ch: number): void
export function memory_append_string(buf: number[], pos: number[], str: string): void
...
export class Attach {
    ...
    static new_from_bytes(bytes: Gjs.byteArray.ByteArray): Attach
